...
public class YoutubeConnector {
    ...
    public static final String KEY = "AIzaSyBxK5_zYqbmWOWgLJuSkotKZ-5-3HKzB2g";
    ...
    public static final String SHA1 = "9D:CD:AA:C2:6C:B6:58:3E:CA:58:25:2F:F9:E5:4A:BF:9C:AE:FF:1A";

    //maximum results that should be downloaded via the YouTube data API at a time
    private static final long MAXRESULTS = 10;
